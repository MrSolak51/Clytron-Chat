...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        messages->setVerticalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        messages->setHorizontalScrollBarPolicy(Qt::ScrollBarAsNeeded);
        messages->setSizeAdjustPolicy(QAbstractScrollArea::AdjustIgnored);
